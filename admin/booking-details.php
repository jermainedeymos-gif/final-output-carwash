<?php
require_once '../model/all-bookings-class.php';

$bookingObj = new AllBookings();

// get id from URL
$id = isset($_GET['id']) ? intval($_GET['id']) : 0;

// fetch booking
$booking = $bookingObj->getBookingById($id);
?>
...
<!-- admin table css-->
<link rel="stylesheet" href="http://192.168.80.168/cwms/admin/css/basictable.css">
<link rel="stylesheet" href="http://192.168.80.168/cwms/admin/css/bootstrap.min.css">
<link rel="stylesheet" href="http://192.168.80.168/cwms/admin/css/font-awesome.css">
<link rel="stylesheet" href="http://192.168.80.168/cwms/admin/css/icon-font.min.css">
<link rel="stylesheet" href="http://192.168.80.168/cwms/admin/css/morris.css">
<link rel="stylesheet" href="http://192.168.80.168/cwms/admin/css/style.css">
<link rel="stylesheet" href="http://192.168.80.168/cwms/admin/css/table-style.css">
...
<div class="left-content">
    ...
    <!--heder end here-->
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="../admin/admin-dashboard.php">Home</a><i class="fa fa-angle-right"></i>Manage New Bookings </li>
    </ol>
    <!--grid-->
    <div class="grid-form">
        <!-- tables -->
                    ...
                    <tbody>
                        <?php if (!empty($booking)): ?>
                            ...
                            <tr>
                                ...
                                <th>Mobile No</th>
                                <td><?php echo htmlspecialchars($booking['mobile_no']); ?></td>
                            </tr>
                            <tr>
                                <th>Package Type</th>
                                <td><?php echo htmlspecialchars($booking['package_type']); ?></td>
                                <th>Washing Point</th>
                                <td><?php echo htmlspecialchars($booking['washing_point']); ?></td>
                            </tr>
                            <tr>
                                <th>Washing Date</th>
                                <td><?php echo htmlspecialchars($booking['wash_date']); ?></td>
                                <th>Washing Time</th>
                                <td><?php echo htmlspecialchars($booking['wash_time']); ?></td>
                            </tr>
                            <tr>
                                <th>Message</th>
                                <td colspan="3"><?php echo htmlspecialchars($booking['message']); ?></td>
                            </tr>
                            <tr>
                                <th>Status</th>
                                <td colspan="3">
                                    ...
                                    echo getStatusLabel($booking['status']);
                                    ?>
                                </td>
                            </tr>
                        <?php else: ?>
