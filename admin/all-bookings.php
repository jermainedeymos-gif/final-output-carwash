<?php
require_once "../page/all-booking-handler.php";
?>
                        ...
                        <?php if (!empty($allBookings)): ?>
                            <?php foreach ($allBookings as $booking): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo htmlspecialchars($booking['wash_date']); ?>
                                    </td>
                                    <td><?php echo htmlspecialchars($booking['wash_time']);?></td>
                                    <td><?php echo htmlspecialchars($booking['created_at']);?></td>
                                    <td>
                                    <td><a id="view" href="booking-details.php?id=<?php echo $booking['id']; ?>">View</a></td>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
