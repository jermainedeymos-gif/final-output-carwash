...
<!-- custom.css-->
 <link rel="stylesheet" href="../assets/custom.css">
    ...
    <div class="left-content">
        ...
        <!--heder end here-->
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="../admin/admin-dashboard.php">Home</a><i class="fa fa-angle-right"></i>Manage Car Washing Points </li>
        </ol>
        <!--grid-->
        <div class="grid-form">
                    ...
                    <table id="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td><a id="edit" href="#">Edit</a> / <a id="delete" href="#">Delete</a></td>
                            </tr>
                            <tr>
                                <td>2</td>
                                <td></td>
